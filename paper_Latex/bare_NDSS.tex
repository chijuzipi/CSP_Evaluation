...
Alexa top 30 websites are chosen to test the functionality of the CSP Applier. We manually tested the homepage diplay,
login, signup and search function of these websites, and the results are listed in the figure 3. 

\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{manual_30_websites}
\caption{Page browsing results of Alexa top 30 websites}
\label{fig_sim}
\end{figure}
